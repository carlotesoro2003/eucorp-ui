import { F as bind_props, B as pop, K as attr, z as push } from "../../../chunks/index.js";
/* empty css                       */
...
function _page($$payload, $$props) {
  ...
  fetchUserProfile();
  $$payload.out += `<div class="hero min-h-screen bg-base-300 overflow-y-auto"><div class="hero-content flex flex-col items-center justify-center"><div class="max-w-md text-center">`;
  if (loading) {
    $$payload.out += "<!--[-->";
    ...
    if (session !== null && profile) {
      $$payload.out += "<!--[-->";
      $$payload.out += `<h1 class="text-white font-bold text-4xl">Edit Profile</h1> `;
      if (uploadedImageUrl) {
        $$payload.out += "<!--[-->";
