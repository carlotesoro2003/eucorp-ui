import { B as pop, z as push, F as bind_props, G as escape_html } from "../../../chunks/index.js";
/* empty css                       */
...
function _page($$payload, $$props) {
  ...
  fetchUserProfile();
  $$payload.out += `<div class="min-h-screen bg-base-300 p-8"><div class="flex flex-col items-center justify-center w-full h-full"><div class="w-full">`;
  if (loading) {
    $$payload.out += "<!--[-->";
